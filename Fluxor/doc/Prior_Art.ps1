...
The Fluxor module was inspired by and/or snippets taken from:
  ...
  Chris Wahl                      -  Initial project idea
  ...
  AlexPetersen and MikeWee        - Solution for Issue #8 "Problem writing cpu.usage.average" which is to use PowerShell culture of 'en-US'
