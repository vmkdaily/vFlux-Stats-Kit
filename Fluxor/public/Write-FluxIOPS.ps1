...
Function Write-FluxIOPS {
  ...
  <#
      ...
      .PARAMETER InputObject
        Object. One or more PowerShell objects to write to InfluxDB. This should be an array of line protocol. The InputObject parameter requires InluxDB line protocol syntax such as that returned by Get-FluxIOPS.
  ...
  #>
    ...
    Process {
        ...
        $InfluxStruct = New-Object -TypeName PSObject -Property @{
            ...
            InfluxDbName          = 'iops'                                        #To follow the examples, set to 'iops' here and run "CREATE DATABASE iops" from Influx CLI if you have not already. To access the cli, SSH to your server and type influx.
