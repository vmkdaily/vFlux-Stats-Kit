...
Function Write-FluxSummary {

  <#

    .DESCRIPTION
      Writes basic VMware vSphere summary information for virtual machines and ESXi hosts to an InfluxDB Server using PowerShell web cmdlets. To feed stats to this cmdlet, use the Get-FluxSummary cmdlet.
