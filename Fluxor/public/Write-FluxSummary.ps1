...
Function Write-FluxSummary {
  ...
  <#
      ...
      .DESCRIPTION
        Writes basic VMware vSphere summary information for virtual machines and ESXi hosts to an InfluxDB Server using PowerShell web cmdlets.
        
        To feed stats to this cmdlet, use the Get-FluxSummary cmdlet.
      ...
      This example shows the basic syntax. You would need to first populate the $summary variable using $summary = Get-FluxSummary -Server 'myvcenter'.
