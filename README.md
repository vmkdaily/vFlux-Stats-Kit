...
PowerShell 3.0 through 5.1.

## PowerCLI Requirements
PowerCLI Module 6.5.4 or greater (10.x or later preferred)
...
We already worked with Get-FluxCompute and Write-FluxCompute. Here, we gather results for
disk performance.
